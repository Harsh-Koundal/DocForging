        ...
        >
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="flex items-center justify-between mb-7 mt-1">
              <label className="flex items-center gap-2 cursor-pointer text-[13px] select-none text-slate-500">
                <input type="checkbox" className="accent-[#3b7ef6] cursor-pointer" />
                Remember me
              </label>
              <a href="#" className="text-[13px] font-medium text-[#3b7ef6] no-underline hover:opacity-75 transition-opacity">
                Forgot password?
              </a>
            </div>
